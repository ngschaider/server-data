...
Config.EnableSocietyPayouts 	= false -- pay from the society account that the player is employed at? Requirement: ngx_society
...
Config.Multichar                = false -- Enable support for ngx_multicharacter
